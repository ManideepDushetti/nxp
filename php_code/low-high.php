...
if(!isset($_SESSION['p_name'])){
 ...
 <html lang="en" dir="ltr">
   <head>
     <meta charset="utf-8">
     <title>Low-High Priced products</title>
   ...
   <body>
       ...
       <div class="container">
         <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
           ...
           <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
             <li><a href="../index.php" class="nav-link px-7 text-white">Home</a></li>
           ...
           <div class="text-end">
             <a href="login_form.php" class="btn btn-outline-light me-2">Login</a>
             <a href="register_form_user.php" class="btn btn-warning">Register</a>
           </div>
         </div>
       </div>
     </header>
     ...
     $i = 1;
     $rows = mysqli_query($conn, "SELECT * FROM bidding where product_name='$product_name' and auction_end_date > '$current_date_time' order by highest_bid")
     ?>
     ...
     $product_name=$_SESSION['p_name'];
     $i = 1;
     $rows = mysqli_query($conn, "SELECT * FROM product_upload where product_name='$product_name' order by price")
     ?>
