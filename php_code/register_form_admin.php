...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      ?>
      <input type="text" name="pin" required placeholder="enter the pin">
      ...
      <p>For home page: <a href="../index.php">Home</a></p>
      <p>Searching for normal user account? <br><a href="register_form_user.php">User page</a></p>
   </form>
