...
if(!isset($_SESSION['p_name'])){
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     ...
     $i = 1;
     $rows = mysqli_query($conn, "SELECT * FROM bidding where product_name='$product_name' and auction_end_date > '$current_date_time'")
     ?>
     ...
     $product_name=$_SESSION['p_name'];
     $i = 1;
     $rows = mysqli_query($conn, "SELECT * FROM product_upload where product_name='$product_name'")
     ?>
