...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    $rows = mysqli_query($conn, "SELECT * FROM bidding where producer='$user_name' and auction_end_date < '$current_date_time'")
    ?>
    ...
    <h1  class="display-5 fw-bold text-center">All your Auctions that you had posted in the past:</h1>
          ...
          <div class="col-md-8 col-lg-6 col-xl-4">
            <div class="card text-black">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between total font-weight-bold mt-4">
                  <span>Starting Bid:</span><span><?php echo $row["starting_bid"];?></span>
                </div>
                <div class="d-flex justify-content-between total font-weight-bold mt-4">
                  <span>Auction end date:</span><span><?php echo $row["auction_end_date"];?></span>
                </div>
                <div class="d-flex justify-content-between total font-weight-bold mt-4">
                  <span>Highest Bid:</span><span><?php echo $row["highest_bid"];?></span>
                </div>
                <div class="d-flex justify-content-between total font-weight-bold mt-4">
                  <span>Bidder:</span><span><?php echo $row["bidder"];?></span>
                </div>
              </div>
            </div>
          </div>
