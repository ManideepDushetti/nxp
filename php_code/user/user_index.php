...
<body>
  ...
  <p class="text-center lead mb-4">If you want to read reviews on users <a href="../reviews_search.php">click here</a></p>
...
<h1  class="display-5 fw-bold text-center">Believing is seeing</h1>
